                                ...
                                <div class="new-member-list">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('backend/assets/imgs/people/avatar4.jpg') }}" alt=""
                                                class="avatar">
                                            <div>
                                                <h6>Patric Adams</h6>
                                        ...
                                        <a href="#" class="btn btn-xs"><i class="material-icons md-add"></i>
                                            Add</a>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('backend/assets/imgs/people/avatar2.jpg') }}" alt=""
                                                class="avatar">
                                            <div>
                                                <h6>Dilan Specter</h6>
                                                <p class="text-muted font-xs">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('backend/assets/imgs/people/avatar3.jpg') }}" alt=""
                                                class="avatar">
                                            <div>
                                                <h6>Tomas Baker</h6>
                                                <p class="text-muted font-xs">
                    ...
                    <li class="dropdown nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownLanguage">
                            <a class="dropdown-item text-brand" href="#"><img
                                    src="{{ asset('backend/assets/imgs/theme/flag-us.png') }}') }}"
                                    alt="English">English</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('backend/assets/imgs/theme/flag-fr.png') }}') }}"
                                    alt="Français">Français</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('backend/assets/imgs/theme/flag-jp.png') }}') }}"
                                    alt="Français">日本語</a>
                            <a class="dropdown-item" href="#"><img
                                    src="{{ asset('backend/assets/imgs/theme/flag-cn.png') }}') }}"
                                    alt="Français">中国人</a>
                        </div>
                    </li>
                    <li class="dropdown nav-item">
                            ...
                            <div class="card mb-4">
                                <article class="card-body">
                                    ...
                                    <div class="new-member-list">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('backend/assets/imgs/people/avatar4.jpg') }}"
                                                    alt="" class="avatar">
                                                <div>
                                                    <h6>Patric Adams</h6>
                                                    <p class="text-muted font-xs">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('backend/assets/imgs/people/avatar2.jpg') }}"
                                                    alt="" class="avatar">
                                                <div>
                                                    <h6>Dilan Specter</h6>
                                                    <p class="text-muted font-xs">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('backend/assets/imgs/people/avatar3.jpg') }}"
                                                    alt="" class="avatar">
                                                <div>
                                                    <h6>Tomas Baker</h6>
                                                    <p class="text-muted font-xs">
