            ...
            <li class="dropdown nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownLanguage">
                    <a class="dropdown-item text-brand" href="#"><img
                            src="{{ asset('backend/assets/imgs/theme/flag-us.png') }}') }}" alt="English">English</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('backend/assets/imgs/theme/flag-fr.png') }}') }}" alt="Français">Français</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('backend/assets/imgs/theme/flag-jp.png') }}') }}" alt="Français">日本語</a>
                    <a class="dropdown-item" href="#"><img
                            src="{{ asset('backend/assets/imgs/theme/flag-cn.png') }}') }}" alt="Français">中国人</a>
                </div>
            </li>
            <li class="dropdown nav-item">
