                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-1"
                                    src="{{ asset('frontend/assets/imgs/slider/slider-1.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-2"
                                    src="{{ asset('frontend/assets/imgs/slider/slider-2.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-3"
                                    src="{{ asset('frontend/assets/imgs/slider/slider-3.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-1.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-3.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-4.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-5.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-6.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-7.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/assets/imgs/shop/category-thumb-8.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-15-1.jpg') }}" alt="">
                                    <img class="hover-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-15-2.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal"
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-9-1.jpg') }}" alt="">
                                    <img class="hover-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-9-2.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal"
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="shop-product-right.html">
                                    <img class="default-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-7-1.jpg') }}" alt="">
                                    <img class="hover-img"
                                        src="{{ asset('frontend/assets/imgs/shop/product-7-2.jpg') }}" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                                <a aria-label="Quick view" class="action-btn small hover-up" data-bs-toggle="modal"
            ...
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0"
                        style="background-image: url('{{ asset('frontend/assets/imgs/banner/menu-banner-7.jpg') }}');">
                        <div class="deal-top">
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated"
                        style="background-image: url('{{ asset('frontend/assets/imgs/banner/menu-banner-8.jpg') }}');">
                        <div class="deal-top">
                    ...
                    <div class="post-list mb-4 mb-lg-0">
                            ...
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('frontend/assets/imgs/blog/blog-2.jpg') }}" alt="">
                                    </a>
                                </div>
                        ...
                        <article class="wow fadeIn animated">
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('frontend/assets/imgs/blog/blog-1.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                                    <div class="entry-meta mb-10 mt-10">
