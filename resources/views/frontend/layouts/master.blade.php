...
<body>
    <!-- Modal -->
    @include('frontend.layouts.header.partials');


    <header class="header-area header-style-1 header-height-2">
        @include('frontend.layouts.header.header')
        @include('frontend.layouts.header.header_search')
    ...
    <!-- Preloader Start -->
    @include('frontend.layouts.footer.partials.preloader')
    <!-- Vendor JS-->
    @include('frontend.layouts.footer.footer_assets')
