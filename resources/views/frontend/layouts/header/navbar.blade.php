<div class="header-bottom header-bottom-bg-color sticky-bar" style="background-color: #2b5882;">
    <div class="container">
        <div class="header-wrap header-space-between position-relative">
                                    ...
                                    <li class="has-children">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('frontend/assets/imgs/banner/menu-banner-5.jpg') }}"
                                                            alt="menu_banner1">
                                                        <div class="banne_info">
                                                            <h6>10% Off</h6>
                                                            <h4>New Arrival</h4>
                                                    ...
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('frontend/assets/imgs/banner/menu-banner-6.jpg') }}"
                                                            alt="menu_banner2">
                                                        <div class="banne_info">
                                                            <h6>15% Off</h6>
                                                            <h4>Hot Deals</h4>
                ...
                <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                    <nav>
                        <ul class="text-color">
                            ...
                            <li>
                                <a href="page-about.html">Groceries</a>
                            </li>
                            <li>
                                <a href="page-about.html">Vegetables</a>
                            </li>
                            <li>
                                <a href="page-about.html">Fashions</a>
                            </li>
                            <li>
                                <a href="page-about.html">Hardware</a>
                            </li>
                            <li>
                                <a href="page-about.html">Stationery</a>
                            </li>
                            <li>
                                <a href="page-about.html">Fish</a>
                            </li>
                            <li>
                                <a href="page-about.html">Shoes</a>
                            </li>
                            <li>
                                <a href="page-about.html">Electronics</a>
                            </li>
                            <li>
                                <a href="page-about.html">Milk</a>
                            </li>
            ...
            {{-- <div class="hotline d-none d-lg-block">
                <p><i class="fi-rs-headset"></i><span>Hotline</span> 6002683577 </p>
            </div> --}}
