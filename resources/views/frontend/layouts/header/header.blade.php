        ...
        <div class="row justify-content-between">
            <div class="col-xl-3 col-lg-4">
                <div class="header-info">
                    <ul>
                        <li><i class="fi-rs-smartphone"></i> <a href="#">6002683577</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="header-info header-info-right">
                    <ul>
                        ...
                        <li><i class="fi-rs-user"></i><a href="{{ route('registration_form') }}">Register</a>
                        <li><i class="fi-rs-user"></i><a href="{{ route('registration_form') }}">Log In</a>
                        </li>
                    </ul>
                </div>
            </div>
